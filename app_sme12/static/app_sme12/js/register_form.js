$(document).ready(function () {
  ...
  //// ------------ Input Mask
  //Datemask dd/mm/yyyy
  $("#id_ent_establish_date").inputmask("9999-99-99", {
  ...
  $("#id_ent_province").change(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        // `data` is the return of the `load_amphur` view function
  ...
  $("#id_ent_amphur").change(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        // `data` is the return of the `load_tumbol` view function
  ...
  $("#id_business_type").change(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        // `data` is the return of the `load_businessgroup` view function
    ...
    $.ajax({
      ...
      success: function (data) {
        // `data` is the return of the `load_employment` view function
    ...
    $.ajax({
      ...
      success: function (data) {
        // `data` is the return of the `load_revenue` view function
  ...
  $("#id_business_model").change(function () {
    var businessmodelGroup = $("#id_business_model option:selected").data(
      "model-group"
    );
    var businesscode = $("#id_business_model option:selected").data(
      "model-code"
    ); // get the selected business_model code from the HTML input
